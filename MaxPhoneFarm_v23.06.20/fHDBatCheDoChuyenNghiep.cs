...
{
	internal JSON_Settings DF0E38BA = null;

	internal string B717538B;

	internal string string_0;

	internal string FE363E91;

	internal int FE34171F;
	...
	public fHDBatCheDoChuyenNghiep(string B91EC1A8, int CB84B69E = 0, string string_1 = "")
	{
		InitializeComponent();
		bool_0 = false;
		B717538B = B91EC1A8;
		...
		DF0E38BA = new JSON_Settings(d399C, D7BE7F11: true);
		Language.SetLanguage(this);
	}

	private void B62453AD()
	{
	...
	private void F01FEA8C(object sender, EventArgs e)
	{
	}

	private void E10ECD92(object sender, EventArgs e)
	{
		Close();
	}

	private void A59C3B87(object sender, EventArgs e)
	{
		...
		if (FE34171F == 0)
		{
			...
			{
				if (Class123.smethod_12(B717538B, text, string_0, text2))
				{
					bool_0 = true;
					Close();
				}
		...
		{
			if (Class123.smethod_14(FE363E91, text, text2))
			{
				bool_0 = true;
				Close();
			}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(fHDBatCheDoChuyenNghiep));
		...
		button1.Click += new System.EventHandler(E10ECD92);
		...
		btnAdd.Click += new System.EventHandler(A59C3B87);
		...
		base.Load += new System.EventHandler(F01FEA8C);
