        ...
        try
        {
            ...
            for (int i = 0; i < lstKey.Count; i++)
            {
                ...
                if (input.Contains(text2))
                {
                    ...
                    {
                        text = text + list[j] + GetIcon(text2, Base.rd);
                    }
            ...
            for (int k = 0; k < matchCollection.Count; k++)
            {
                ...
                {
                    text = text + list2[l] + Common.CreateRandomNumber(Convert.ToInt32(matchCollection[k].Groups[1].Value));
                }
            ...
            for (int m = 0; m < matchCollection.Count; m++)
            {
                ...
                {
                    text = text + list3[n] + Common.CreateRandomString(Convert.ToInt32(matchCollection[m].Groups[1].Value));
                }
